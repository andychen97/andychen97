...
<br> :deciduous_tree: Completed 2 versions of my personal portfolio website (v1:JSX/React and v2:TSX/React/Vite.js).
<br> :deciduous_tree: Completed 2 versions of my personal portfolio website (JSX/React/React/Vite.js/Tailwind CSS, and Three.js).
